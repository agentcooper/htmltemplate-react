...
var TMPL_LOOP = React.createClass({
    ...
    render: function() {
        var property = parsePropertyFromProps(this.props);
...
var TMPL_VAR = React.createClass({
    render: function() {
        ...
        return <span>{(this.props.__local || state)[propertyName]}</span>;
    }
});
...
var TMPL_IF = React.createClass({
    render: function() {
        ...
        if (this.props.__local[parsePropertyFromProps(this.props)]) {
